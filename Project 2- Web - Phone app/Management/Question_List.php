                                        ...
                                        $.ajax({
                                            ...
                                            success:function (data) {
                                                if(!data['error']){
                                                    $("#tableQ").html('<br/>');
                                                    for (var i=0;i<data['subCat'].length;i++){
                                                        $("#tableQ").append('<tr> <td>'+data['subCat'][i]['i']+'</td><td>'+data['subCat'][i]['Question']+'</td><td>'+data['subCat'][i]['level']+'</td><td>'+data['subCat'][i]['subcategory']+'</td><td><a href="Question_Edit.php?id='+data['subCat'][i]['sid']+'" target="_blank"><button class="btn btn-primary btn-xs">ویرایش</button></a></td></tr>');
                                                    }
                                                }
                                            }
                                        })
