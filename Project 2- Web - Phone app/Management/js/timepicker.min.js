...
!function (e, t) {
    ...
    "use strict";
    var e = "_jw-tpk", t = "250px", n = "140px", i = "-container", s = "-header", r = "-body", o = "-hour",
        a = "-minute", l = "-selected", c = "-dragging", u = {hour: "data-hour", minute: "data-minute"},
        d = {hour_list: "hour_list_id", minute_list: "minute_list_id"}, h = {
            namespace: e,
            width: t,
            height: n,
            container_class: i,
        ...
        v = {en: {hour: "Hour", minute: "Minute"}, pt: {hour: "Hora", minute: "Minuto"}}, g = f, _ = {
            container: e + i,
            header: e + s,
            body: e + r,
            hour: e + o,
            ...
            focusable: /^(?:input|select|textarea|button|object)$/i, clickable: /^(?:a|area)$/i, classRegex: function (e) {
                ...
                if (Array.isArray(e)) {
                    if (n = document.createElement(e[0]), e[1].id && (n.id = e[1].id), e[1].classname && (n.className = e[1].classname), e[1].attr) {
                        var i = e[1].attr;
                        if (Array.isArray(i)) for (var s = -1; ++s < i.length;) n.setAttribute(i[s].name, i[s].value); else n.setAttribute(i.name, i.value)
                    }
                ...
                var s, r, o = null, a = !1, l = "in" === i ? m.start_fade_in : m.start_fade_out,
                    c = "in" === i ? m.end_fade_in : m.end_fade_out, u = function (d) {
                        o || (e.publish(l, {target: t}), o = d), "in" === i ? (s = +t.style.opacity + (d - o) / n, a = s >= 1) : (s = +t.style.opacity - (d - o) / n, a = s <= 0), t.style.opacity = s, a ? e.publish(c, {target: t}) : r = window.requestAnimationFrame(u)
                    };
    ...
    var E = function (e) {
        var t, n, i, s, r, o, a = e.container.element, l = {}, c = function (e) {
    ...
    b.prototype.init = function () {
        ...
        var t = this.targets[e].element, n = y.offset(t), i = this.Base.container.size, s = n.top + n.height + 5,
            r = y.getWindowSize();
        ...
        }), this.request_ani_id = y.fade(this.events, this.container, 400), this.Base.dispatchEvent(m.open, {element: t}), this.handleOpen(e)
        ...
        }), this.request_ani_id = y.fade(this.events, this.container, 800, "out"), this.Base.dispatchEvent(m.close, {element: this.targets[e].element})
        ...
        var t, n = this, i = this, s = this.targets[e].hour, r = this.targets[e].minute;
        ...
        }, !1), this.opened = !0, this.id_active = e, this.closeWhen = {hour: !1, minute: !1}
        ...
        var e = this, t = y.$(g.ids.hour_list), n = y.$(g.ids.minute_list), i = function (t) {
            t.preventDefault();
    ...
    var A = function (t) {
        function n(i, s) {
            ...
            var r = new w(this), o = r.createPicker(), a = new E(this);
