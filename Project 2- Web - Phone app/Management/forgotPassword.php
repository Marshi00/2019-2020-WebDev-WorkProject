...
<div class="dll37">
    ...
    <form class="form-signin col-lg-4 col-md-4 col-sm-6 col-xs-6 "><!--inputs-->
        <div class="login-wrap sl83 fpl55">
            <h4>
                شماره تلفن همراه خود را وارد کنید
            </h4>
            <input type="number" id="A1" class="form-control " placeholder="شماره ی تلفن خود را وارد کنید" autofocus>
            <br>
            <br>
            <button class="btn btn-lg btn-login btn-block" type="button" onclick="sendParams()" id="AAA">ارسال رمز عبور جدید</button>
            <br>
        </div>
    </form><!--inputs-->
        ...
        $.ajax({
            ...
            success: function (jsonData) {
                if (jsonData['error']) {
                    ...
                    Notiflix.Report.Success(jsonData['MSG'],'','بستن');
                    let reportTimeout = setTimeout(function(){
                        document.getElementById("NXReportButton").click();
                        clearTimeout(
                            reportTimeout
