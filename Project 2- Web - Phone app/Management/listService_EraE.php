...
<html lang="en">
<head>
    <title>لیست سرویس های ارائه شده</title>
                                        ...
                                        $.ajax({
                                            ...
                                            success:function (data) {
                                                if(!data['error']){
                                                    $("#tableQ").html('<br/>');
                                                    for (var i=0;i<data['subCat'].length;i++){
                                                        $("#tableQ").append('<tr> <td>'+data['subCat'][i]['i']+'</td><td>'+data['subCat'][i]['text']+'</td><td>'+data['subCat'][i]['status']+'</td><td><a href="Edit_serviceEraE.php?id='+data['subCat'][i]['id']+'" target="_blank"><button class="btn btn-primary btn-xs">ویرایش</button></a></td></tr>');
                                                    }
                                                }
                                            }
                                        })
