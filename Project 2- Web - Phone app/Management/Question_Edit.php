...
$user_id = $_SESSION['id'];
$id = $_GET['id'];
$infoVal=$A->Query("SELECT * FROM subcategoryquestions WHERE id='$id'");
...
<!--                            </div>-->
                            ...
                            <div class="form-group container-fluid">
                                ...
                                <br>
                                <input type="text" class="form-control" id="Question" value="<?php echo $infoValFetch['Question']?>">
                            </div>
                            <div class="form-group container-fluid">
                                <label for="level">اولویت سوال خود را وارد کنید</label>
                                <br>
                                <input type="text" class="form-control" id="level" value="<?php echo $infoValFetch['level']?>">
                            </div>
