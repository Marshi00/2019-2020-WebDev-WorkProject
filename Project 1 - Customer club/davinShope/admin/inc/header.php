            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="addSize.php">اضافه کردن سایز</a></li>
                        <li><a class="" href="sizeList.php">لیست سایز</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="addProperties.php">اضافه کردن ویژگی محصول</a></li>
