...
(function webpackUniversalModuleDefinition(root, factory) {
    if(typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(require("Projects/davinShope/admin/js/jquery"));
    else if(typeof define === 'function' && define.amd)
        define(["Projects/davinShope/admin/js/jquery"], factory);
    else if(typeof exports === 'object')
        exports["cropit"] = factory(require("Projects/davinShope/admin/js/jquery"));
    else
