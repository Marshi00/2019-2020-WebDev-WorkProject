    ...
    <div class="col-lg-12" id="adminform">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <select id="cat" onchange="getSubCatt()">
                ...
                <select id="subCat" onchange="getproductt()">
                ...
                <div class="form-group" >
                    ...
                    <input id="value" type="number" class="form-control" id="specialOfferPercentage" placeholder="تعداد">
                </div>


                <span class="btn btn-lg btn-login btn-block" onclick="submitt()">ثبت</span>
            </div>
        </section>
    </div>
