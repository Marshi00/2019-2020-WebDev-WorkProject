...
if(isset($_SESSION['loginAdmin']) && $_SESSION['loginAdmin']=true) {
    if (
        ...
        isset($_POST['ocEndDate']) && $_POST['ocEndDate'] != ''
    ) {
        $result = $db::RealString($_POST);
        $offer = $result['offer'];
        $count = $result['count'];
        $ocPercentage = $result['ocPercentage'];
        $ocEndDate = $result['ocEndDate'];
        ...
        $insert = $db::Query("INSERT INTO offercode(ocid, occode, ocregdate, ocregtime, occount, ocadminid, ocpercentage,OCendDate) 
        VALUES  ('$id','$offer','$data','$time','$count','$idAdmin','$ocPercentage','$ocEndDate') ");
