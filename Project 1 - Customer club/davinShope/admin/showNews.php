                        ...
                        if (mysqli_num_rows($news) > 0) { ?>
                            ...
                            while ($fetch = mysqli_fetch_assoc($news)) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;height: 52px"><img  style="width: 53%;height: 59px;" src="upload/news/<?php echo $fetch['newsImg']?>"></td>
                                    <td>
                                        <a href="editNews.php?newsId=<?php echo $fetch['newsId']?>">
                                            <button class="btn btn-primary btn-xs"><i class="icon-pencil"></i></button>
                                    </td>
                                    <td>
                                        <a href="deleteNews.php?newsId=<?php echo $fetch['newsId']?>">
