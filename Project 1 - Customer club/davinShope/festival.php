...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 1%"><!--Pictures list / item list-->
    <div class="container-fluid ioioioioioi">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" style="width: 100%!important;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: right">
                <h3>نتیجه جستوجوی شما : <?php echo $fetch['festivalName'] ?></h3>
            ...
            <?php
            $cat = $db::Query("SELECT * FROM festival,festivalproduct,product WHERE festivalId='$id' AND fePrFestivalId=festivalId AND fePrProductId=productId");
            while ($fetch = mysqli_fetch_assoc($cat)){
                ...
                <a href="Product.php?$proId=<?php echo $proId?>">
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-6" style="text-align: center">
                        ...
                        <p><?php echo @$db::toMoney($price3- $off3)?> ریال </p>
                    </div>
                </a>
