...
if(
    ...
    if (isset($_SESSION['loginUser']) && $_SESSION['loginUser'] == true) {
        ...
        $select = $db::Query("SELECT * FROM shoppingbasket where SHBPay='0'");
        ...
        $select = $db::Query("SELECT * FROM shoppingbasket where
                                   SHBPay='0' AND shoppingbasket.SHBGuest='$GustId'");
        if (mysqli_num_rows($select) == 0) {
