    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">سابقه ی خرید</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="col-10 divlotery">
                <?php
                $factor = $A->Query("SELECT * FROM factor WHERE UserID='$getUser'");
                ?>
                <table id="table04" align="center" width="800px">
                    ...
                    while ($rowfactors = mysqli_fetch_assoc($factor)) {
                        ...
                        <tr class="clas1">
                            <td><?php echo $i ?></td>
                            <td><a target="_blank" href="Receipt.php?id=<?php echo $rowfactors['FactorID'] ?>"
                                   class="atag"><?php echo $rowfactors['FactorID'] ?></a></td>
