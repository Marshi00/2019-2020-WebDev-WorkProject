...
<head>
  ...
  <!--new css-->
  <link rel="stylesheet" href="css/infotablestyle.css">
</head>
          ...
          <div class="dl61">
              ...
              <div class="user-panel mt-3 pb-3 mb-3 nav-sidebar">
                  ...
                  <div class="nav-link dl81">
                      <a href="info.php" class="nav-link bbbl81">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">اطلاعات من</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="col-lg-12 md12 xs12 col-sm-12 div01" >
            <form >
                <div class="col-lg-8 col-md-8 col-xs-10 col-sm-10 aaa111" >
                    <table class="idtable" align="center">
                        <tr  class="clas1" >
                            <th class="trid1" colspan="2"  >
                                <h5>اطلاعات من</h5>
                            </th>
                        </tr>
                        <tr class="clas1" >
                        ...
                        <tr class="clas1" >
                            ...
                            <td>
                                <?php echo $info['FixedPhoneNumber']?>
                            </td>
                        </tr>
                        <tr class="clas1" >
                            <td>
                                شماره ی موبایل دعوت کننده
                            </td>
                            <td>
                                <?php echo $info['InviterID']?>
                            </td>
                        </tr>
                        <tr class="clas1" >
                            <td>
                ...
                <div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 div574">
                        <a class="atag268 btn-warning" target="_blank" href="completing%20info.php">
                            تکمیل
                        </a>
                    </div>
                    <!--edit info button-->
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 div574">
                        <a class="atag575 btn-success" target="_blank" href="editinfo.php">
                            ویرایش
                        </a>
                    </div>
                </div>
