  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="my%20point.php" class="nav-link">صفحه ی اصلی</a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
              ...
              <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                      ...
                      <li class="nav-item has-treeview">
                          <a href="festivals.php" class="nav-link active aaa1">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">جشنواره ها</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="col-10 divlotery">
            ...
            ?>
            <table id="table04" align="center" width="800px" >
                <thead class="tthf">
                <tr class="clas1">
                    <th >
                        ردیف
    ...
    <!--<div class="md-form active-pink active-pink-2 mb-3 mt-0">-->
      <!--<input class="form-control" type="text" placeholder="Search" aria-label="Search" id="searchcard">-->
    <!--</div>-->
  </div>
</div>
