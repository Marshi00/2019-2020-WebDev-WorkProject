...
<head>
    <meta charset="UTF-8">
    <title>ویرایش مشتری اقساطی</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="col-12">
            <button type="button" class="btn btn-primary col-12 btnl48"><h3>ویرایش مشتری اقساطی</h3></button>
        </div>
        ...
        <div class="col-8 div01" align="center">
            ...
            <input type="text" id="A2" value="<?php echo $userId ?>" disabled name="firstname">
...
<script>
    function sendParams() {
        ...
        CompanyID = document.getElementById('A11').value;
        ContractID = document.getElementById('A10').value;
        ...
        $.ajax({
            url: "2-3UPdateContractUsersDavin.php",
            data: {
