...
<div class="content-wrapper">
    <div class="col-12">
        <button type="button" class="btn btn-primary col-12 btnl482"><h3>ثبت فاکتور</h3></button>
    </div>

    <div class="col-8 div1" align="center">
        <input type="text" id="A1" name="firstname" placeholder="شناسه فاکتور را وارد کنید ...">
        ...
        <input type="text" id="A7" name="lastname" placeholder="مبلغ فاکتور را وارد نمایید">
        ...
        <select id="A6">
            <option selected disabled>شناسه قرارداد</option>
            <?php
