...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <button type="button" class="btn btn-primary col-12 btnl48"><h3>ثبت شرکت</h3></button>
        </div>

        <div class="col-8 div01" align="center">
            <input type="text" id="A1" name="firstname" placeholder="نام شرکت را وارد کنید ...">

            <input type="number" id="A5" name="lastname" placeholder="کد اقتصادی را وارد کنید ...">
            <input type="number" id="A3" name="firstname" placeholder="شماره ملی شرکت را وارد کنید ...">

            <input type="number" id="A2" name="lastname" placeholder="شماره ثبت شرکت را وارد کنید ...">
            <input type="number" id="A4" name="firstname" placeholder="شماره تلفن  ثابت را وارد کنید ...">
...
<script>
    function sendParams() {
        var CompanyName, CompanyRegistrationNumber, CompanyNationalID, FixedPhoneNumber, EconomicCode, Province,
            City;
        ...
        $.ajax({
            url: "6-1SubmitCompanyTableDavin.php",
            data: {
