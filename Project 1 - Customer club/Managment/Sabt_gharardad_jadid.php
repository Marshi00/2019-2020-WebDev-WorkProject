...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <button type="button" class="btn btn-primary col-12 btnl48"><h3>ثبت قرارداد جدید</h3></button>
        </div>
        ...
        <div class="col-8 div01" align="center">
            ...
            <input type="text" id="DateEnd" placeholder="برای انتخاب تاریح پایان کلیک کنید" class="inputinfo">
...
<script>
    function sendParams() {
        ...
        $.ajax({
            url: "4-1SubmitCompanyContractTableDavin.php",
            data: {
                CompanyID: CompanyID,
